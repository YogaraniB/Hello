...
<font  color="white">
		...
		<tr>
			...
			<tr>
				<td><b>Quantity:<b></td>
				<td><select id="fQty" onchange="calculatePrice()" name="Qty"><option></option>
           ...
           <%--  
              ...
              <div class="wrapper indent-bot">
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img1.jpg"/>" alt="" class="img-indent">
                ...
                <div class="grid_7">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img2.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                ...
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img3.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
              ...
              <div class="wrapper indent-bot">
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img4.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                ...
                <div class="grid_7">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img5.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Corn</a> </dt>
                      <dd> Vivamus hendrerit mauris ut du gravida ut viverra lectus tincidunt. Cras mattis tempor eros. </dd>
                    </dl>
                ...
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img6.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
              ...
              <div class="wrapper hr-border-1 indent-bot-2">
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img7.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                ...
                <div class="grid_7">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img8.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                ...
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="<c:url value="/resources/images/page2-img9.jpg"/>" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
