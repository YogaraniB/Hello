        ...
        <div class="grid_24 content-bg">
          <div class="wrapper">
            ...
            <article class="grid_15 suffix_1 omega">
              <h2>Our Stocks and Prices:</h2>
              <div class="wrapper">
                <div class="grid_7 suffix_1 alpha">
                <c:forEach var="b" items="${li}">
                
                  <ul class="price-list">
                    <li><a href="customerlogin" class="price-item"><c:out value="${b.productname}" /></a><span class="price"><c:out value="${b.price}" /></span><span class="filler">&nbsp;</span></li>
