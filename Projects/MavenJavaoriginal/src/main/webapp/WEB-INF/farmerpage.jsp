...
<div class="main-bg">
  ...
  <section id="content">
	...
	<form action="formvalidationfarmer" method="post">
<table>
 <tr><td><b>Farmer Id:</b></td>
<td><input type="text" name="farmerid"></td></tr>
...
<a href="registrationfarmer"><font >New Farmer? Click here to register</font></a>
 </article>
          </div>
        </div>
      </div>
