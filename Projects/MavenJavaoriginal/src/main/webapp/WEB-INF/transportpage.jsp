        ...
        <div class="grid_24 content-bg">
          <div class="wrapper">
            <article class="grid_22 suffix_1 prefix_1 alpha omega">
              ...
              <center>
               <form action="registersavetransport" method="post">
<font  color="white">
		<table>
		<tr>
				<td><b>Transport Id:<b></td>
				<td><input type="text" name="id" placeholder="Transport Id"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><b>Vehicle:<b></td>
				<td><input type="text" name="vehicle" placeholder="Vehicle"></td>
			</tr>
			<tr>
